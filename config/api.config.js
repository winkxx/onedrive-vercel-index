 ...
 *   In which case you would need to change directLinkRegex.重启
 */
module.exports = {
  // The clientId and clientSecret are used to authenticate the user with Microsoft Graph API using OAuth. You would
  // not need to change anything here if you can authenticate with your personal Microsoft account with OneDrive International.
  clientId: '5418f473-0ca7-4a2c-a606-ff1b18f9c824',
  obfuscatedClientSecret: 'U2FsdGVkX18kxMSyuXNV4CAa/floQjODKdi7y8nJeV9vnfaItCccHKHmkzJvZIUSgd22uTtjQv7DIjozWCPuBw==',
